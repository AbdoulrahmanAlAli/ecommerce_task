    ...
    <div className="bg-gray-100 min-h-screen font-sans">
      ...
      <section className="bg-blue-600 text-white py-24">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <a href="/product" className="bg-white text-blue-600 py-2 px-6 rounded-lg text-lg font-semibold hover:bg-gray-100 transition">Shop Now</a>
        </div>
      </section>
        ...
        {products.length > 0 ? (
          products.slice(0, 4).map((product: Product) => (
            <div  key={product.id} className="bg-white p-6 rounded-lg shadow-lg">
              <img src="https://via.placeholder.com/200" alt="Product 2" className="w-full h-48 object-cover rounded-lg mb-4" />
              <h3 className="text-xl font-semibold mb-2">{product.title}</h3>
              <p className="text-gray-600 mb-4">${product.price}</p>
              <a href="/product/2" className="text-blue-600 hover:underline">{product.description}</a>
            </div>
          ))
        ) : (
